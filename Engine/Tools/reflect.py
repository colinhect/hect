                ...
                for description in descriptions:
                    for para in description.findall("para"):
                        if not para.text is None:
                            ...
                            elif "[mode]" in para.text:
                                class_type.is_mode = True
...
if __name__ == "__main__":
    ...
    with open("Doxyfile", "w") as doxyfile:
        ...
        doxyfile.write("ALIASES += mode=\"[mode]\"\n")
    ...
    with open(header_file_name, "w") as f:
        ...
        f.write("#include <Hect/Logic/ModeRegistry.h>\n")
        ...
        f.write("\n    // Game modes\n")
        for type in types:
            if isinstance(type, ClassType) and type.is_mode:
                print("Found game mode '" + type.name + "'")
                f.write("    hect::ModeRegistry::registerType<" + type.name + ">();\n")
        f.write("}\n\n")
        f.write("}\n")
