...
if __name__ == "__main__":
    ...
    with open(header_file_name, "w") as f:
        ...
        f.write("#include <Hect/Scene/ComponentRegistry.h>\n")
        f.write("#include <Hect/Scene/SceneRegistry.h>\n")
        f.write("#include <Hect/Scene/SystemRegistry.h>\n")
        ...
        f.write("\n    // Scenes\n")
        for type in types:
            if isinstance(type, ClassType) and type.is_scene:
                print("Found scene '" + type.name + "'")
                f.write("    hect::SceneRegistry::registerType<" + type.name + ">();\n")
        f.write("}\n\n")
        f.write("}\n")
