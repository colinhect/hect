...
if __name__ == "__main__":
    ...
    # Write .h file
    with open(os.path.join(output_dir, "RegisterTypes.h"), "w") as code:
        code.write("// Generated by reflect.py\n\n")
        code.write("namespace " + namespace + "\n")
        code.write("{\n\n")
        code.write("void registerTypes();\n\n")
        code.write("}\n")

    # Write .cpp file
    with open(os.path.join(output_dir, "RegisterTypes.cpp"), "w") as code:
        code.write("// Generated by reflect.py\n\n")
